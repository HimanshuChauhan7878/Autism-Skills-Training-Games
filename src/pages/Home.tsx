      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <GameCard
            ...
            imageUrl="https://images.unsplash.com/photo-1470790376778-a9fbc86d70e2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
            onPlay={() => navigate('/emotion-game')}
          />
          <GameCard
            title="Shape Detection Game"
            description="Challenge your pattern recognition skills with various shapes and patterns."
